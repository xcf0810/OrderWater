...
<br/>
<br/>
<h2 align="center" style="color: #0e90d2">产品清单</h2>
<form method="post" action="orderWater">
    <table align="center" align="center"  border="1" cellspacing="0" cellpadding="0" style="border-collapse:collapse" bordercolor="#0099FF"  >
        <tr align="center" style=" background-color: #0e90d2;font-weight: bold;height: 30px;color: #FFFFFF"  >
            <td align="center"  style="width: 60px">选中</td>
            <td align="center" style="width: 200px">品牌</td>
            <td  align="center"style="width: 80px" >单价</td>
            <td align="center" style="width: 80px">订购数量</td>
        </tr>
<%--遗留问题，foreach传值，后台没有用数组接，所以只有第一个num会真正改变--%>
        <c:forEach items="${WaterList}" var="water">
            <tr align="center">
                <td align="center"><input name="wtId" type="radio" value="${water.wtId}"/></td>
                <td align="center">${water.sId}</td>
                <td align="center">${water.wtCost}</td>
                <td align="center" ><input style="width: 20px" type="text" name="num" value="1"   /></td>
            </tr>
        </c:forEach>
